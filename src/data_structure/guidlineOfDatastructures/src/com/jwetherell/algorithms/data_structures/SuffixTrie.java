...
import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.Trie.Node;
import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.interfaces.ISuffixTree;
import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.interfaces.ISuffixTree;
...
public class SuffixTrie<C extends CharSequence> implements ISuffixTree<C> {
    ...
    private Set<String> getSuffixes(Trie.Node node) {
        ...
        if (node.character != Trie.Node.SENTINAL) builder.append(node.character);
