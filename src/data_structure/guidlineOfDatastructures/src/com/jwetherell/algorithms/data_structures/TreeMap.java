package data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures;

import java.util.ArrayList;
import java.util.List;

import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.BinarySearchTree.INodeCreator;
import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.BinarySearchTree.Node;
import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.interfaces.IMap;
import data_structure.guidlineOfDatastructures.src.com.jwetherell.algorithms.data_structures.interfaces.IMap;
...
public class TreeMap<K extends Comparable<K>, V> implements IMap<K,V> {
     ...
     */
    public TreeMap(BinarySearchTree.INodeCreator<K> creator) {
        tree = new AVLTree<K>(creator);
    }
    ...
    private static class JavaCompatibleTreeMap<K extends Comparable<K>,V> extends java.util.AbstractMap<K,V> {
        ...
        private void levelOrder(BinarySearchTree.Node<K> node, java.util.Set<java.util.Map.Entry<K, V>> set) {
